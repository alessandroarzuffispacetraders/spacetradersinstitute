...
export const CHANNELS: Channel[] = [
  // Annunci
  {
    id: 'avvisi',
    name: 'avvisi',
    description: 'Comunicazioni ufficiali IST',
    type: 'bacheca',
    channelKind: 'group',
    category: 'Annunci',
    categoryIcon: '📢',
  ...
  {
    id: 'aggiornamenti-corso',
    name: 'aggiornamenti-corso',
    description: 'Novità e aggiornamenti del programma',
    type: 'bacheca',
    channelKind: 'group',
    category: 'Annunci',
    categoryIcon: '📢',
  ...
  // Community
  {
    id: 'generale',
    name: 'generale',
    description: 'La chat della community IST',
    type: 'chat',
    channelKind: 'group',
    category: 'Community',
    categoryIcon: '💬',
  ...
  },
  {
    id: 'trading-ideas',
    name: 'trading-ideas',
    description: 'Analisi, setup e idee operative',
    type: 'chat',
    channelKind: 'group',
    category: 'Community',
    categoryIcon: '💬',
  ...
  // Coaching (group)
  {
    id: 'gruppo-coach',
    name: 'gruppo-coach',
    description: 'Gruppo privato con il tuo coach',
    type: 'chat',
    channelKind: 'group',
    category: 'Coaching',
    categoryIcon: '🎯',
  ...
  },
  {
    id: 'dm-sofia',
    name: 'Sofia Verdi',
    description: 'Mental Coach',
    type: 'chat',
    channelKind: 'direct',
    category: 'Privati',
    categoryIcon: '',
    roles: ['student', 'mental_coach', 'admin'],
    canPost: ['student', 'mental_coach', 'admin'],
    dmWith: { name: 'Sofia Verdi', role: 'mental_coach', online: false },
  },
  {
    id: 'dm-admin',
    name: 'Admin IST',
    description: 'Staff IST',
    type: 'chat',
    channelKind: 'direct',
    category: 'Privati',
    categoryIcon: '',
    roles: ['student', 'admin'],
    canPost: ['student', 'admin'],
    dmWith: { name: 'Admin IST', role: 'admin', online: true },
  },
]
